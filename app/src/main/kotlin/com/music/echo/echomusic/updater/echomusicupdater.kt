...
package echo.music.iad1tya.LYRA.updater
...
import echo.music.iad1tya.LYRA.updater.downloadmanager.UpdateDownloadWorker
import echo.music.iad1tya.LYRA.updater.downloadmanager.DownloadNotificationManager
                                ...
                                AnimatedActionButton(
                                    ...
                                    onClick = {
                                        if (isDownloadComplete) {
                                            ...
                                            val urlToDownload = currentStatus.apkUrl ?: "https://github.com/LYRAApp/Echo-Music/releases/download/${currentStatus.version}/LYRA.apk"
...
suspend fun checkForUpdate(
    ...
    withContext(Dispatchers.IO) {
        try {
            val url = URL("https://api.github.com/repos/LYRAApp/Echo-Music/releases/latest")
            ...
            if (shouldShow) {
                ...
                try {
                    val changelogUrl =
                        URL("https://github.com/LYRAApp/Echo-Music/releases/download/$tagWithPrefix/changelog.json")
