package echo.music.iad1tya.LYRA
...
object UpdateNotificationHelper {
    ...
    fun showUpdateNotification(context: Context, versionName: String) {
        ...
        val apkUrl = if (versionName.contains("nightly", ignoreCase = true)) {
            "https://nightly.link/LYRAApp/workflows/nightly.yml/main/LYRA-gms-nightly.zip"
        } else {
            "https://github.com/LYRAApp/Echo-Music/releases/download/$versionName/LYRA.apk"
        }
