...
import echo.music.iad1tya.LYRA.component.UpdateInfoDialog
import echo.music.iad1tya.ui.utils.backToMain
import echo.music.iad1tya.LYRA.updater.getAutoUpdateCheckSetting
import echo.music.iad1tya.LYRA.updater.saveAutoUpdateCheckSetting
import echo.music.iad1tya.LYRA.updater.getUpdateAvailableState
import echo.music.iad1tya.LYRA.updater.saveUpdateAvailableState
import echo.music.iad1tya.LYRA.updater.getUpdateNotificationsSetting
import echo.music.iad1tya.LYRA.updater.saveUpdateNotificationsSetting
import android.widget.Toast
import androidx.compose.ui.res.pluralStringResource
import echo.music.iad1tya.LYRA.updater.getDownloadedApkCount
import echo.music.iad1tya.LYRA.updater.clearDownloadedApks
import echo.music.iad1tya.LYRA.updater.getBetaUpdatesSetting
import echo.music.iad1tya.LYRA.updater.saveBetaUpdatesSetting
import echo.music.iad1tya.LYRA.updater.autoClearOldApks
...
fun UpdateSettings(
    ...
    isHighlighted = (highlightKey == stringResource(R.string.system_update)),
                    ...
                    onClick = {
                        ...
                        if (isFoss) {
                            val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/LYRAApp/Echo-Music"))
